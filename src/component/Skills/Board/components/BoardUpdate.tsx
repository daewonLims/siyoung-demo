...
<div>
    <h2>boardUpdate</h2>
     <div>{dumyBoardUpdate.boardIndex }</div>
     <div><input type="text" id="boardUpdateTitle" value={boardUpdate.board_update_title}
        onChange={(e)=>{let value = e.target.value;
          onChangeBoardUpdate(value, true)}}  /> </div>
     <div><input type="text" id="boardUpdateContent"  value={boardUpdate.board_update_content}
        onChange={(e)=>{
